...
const Chat = () => {
  ...
  return (
    <div className="flex h-screen">
      <div className="bg-white w-1/3 flex flex-col right-bar">
        <Logo />
        ...
        <div className="flex-grow">
          {!selectedUserId && (
            <div className="flex items-center justify-center h-full">
              <div className="text-gray-300">&#128072; Select a contact to chat</div>
            </div>
          )}
          {!!selectedUserId && (
              ...
              <div className="overflow-y-scroll absolute top-0 left-0 right-0 bottom-2">
                {messagesWithoutDupes.map((message) => (
                  <div
                    key={message._id}
                    className={
                      message.sender === user._id ? "text-right pr-2" : "text-left"
                    }
                  >
                    <div
                      className={
